...
},{"buffer":5,"gzNCgL":4}],2:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(a){var o=require("./contrib/anime.js"),i=a(".site-header"),r=function(){o.remove(i.find("img")[0]),o.remove(i[0])},s=function(n){var e=250;20<n?(i.find("a").addClass("color-blue"),i.find("a").removeClass("color-white"),r(),o({targets:i.find(".site-header-main")[0],height:"60px",duration:e,easing:"easeInQuad"}),o({targets:i[0],backgroundColor:["hsla(0, 0%, 100%,1)","hsla(0, 0%, 100%,1)"],duration:e})):(i.find("a").addClass("color-white"),i.find("a").removeClass("color-blue"),r(),o({targets:i.find(".site-header-main")[0],height:"80px",duration:e,easing:"easeInQuad"}),o({targets:i[0],backgroundColor:["hsla(0, 0%, 100%,0)","hsla(0, 0%, 100%,0)"],duration:e,easing:"easeInQuad"}))};function n(){a(window).unbind("scroll.event"),767<a(window).innerWidth()?(i.css("background","unset"),a(window).on("scroll.event",function(n){console.log("launch");var e=a(window).scrollTop();s(e)})):i.css("background","white")}n(),a(window).on("resize",function(){n()})}(jQuery);
}).call(this,require("gzNCgL"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_42dd7925.js","/")
},{"./contrib/anime.js":1,"buffer":5,"gzNCgL":4}],3:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"buffer":5,"gzNCgL":4}],4:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"buffer":5,"gzNCgL":4}],5:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/*!
...
},{"base64-js":3,"buffer":5,"gzNCgL":4,"ieee754":6}],6:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
